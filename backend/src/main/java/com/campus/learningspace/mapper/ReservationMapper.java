...
public interface ReservationMapper extends BaseMapper<Reservation> {
    @Select("""
            SELECT
              ...
              r.status,
              r.qrcode,
              r.qrcode_expire_time AS qrcodeExpireTime,
              r.qrcode_scan_status AS qrcodeScanStatus,
              r.qrcode_scan_time AS qrcodeScanTime,
              r.qrcode_scan_device_uid AS qrcodeScanDeviceUid,
